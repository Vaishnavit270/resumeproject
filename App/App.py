...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Vaish@27',db='cv')
...
def run():
    ...
    link = '<b> style="text-decoration: none; color: #021659;"></a></b>' 
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if resume_data['name']:
                    ...
                    st.warning("No name detected in the resume.")
                ...
                if 'Objective' or 'Summary' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add your career objective, it will give your career intension to the Recruiters.</h4>''',unsafe_allow_html=True)

                if 'Education' or 'School' or 'College'  in resume_text:
                    resume_score = resume_score + 12
                    st.markdown('''<h5 style='text-align: left; color: #1ed760;'>[+] Awesome! You have added Education Details</h4>''',unsafe_allow_html=True)
                else:
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Education. It will give Your Qualification level to the recruiter</h4>''',unsafe_allow_html=True)
                ...
                if 'EXPERIENCE' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: ##FFB6C1;'>[-] Please add Experience. It will help you to stand out from crowd</h4>''',unsafe_allow_html=True)
                ...
                if 'INTERNSHIPS'  in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Internships. It will help you to stand out from crowd</h4>''',unsafe_allow_html=True)
                ...
                if 'SKILLS'  in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Skills. It will help you a lot</h4>''',unsafe_allow_html=True)
                ...
                if 'HOBBIES' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Hobbies. It will show your personality to the Recruiters and give the assurance that you are fit for this role or not.</h4>''',unsafe_allow_html=True)
                ...
                if 'INTERESTS'in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Interest. It will show your interest other that job.</h4>''',unsafe_allow_html=True)
                ...
                if 'ACHIEVEMENTS' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Achievements. It will show that you are capable for the required position.</h4>''',unsafe_allow_html=True)
                ...
                if 'CERTIFICATIONS' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Certifications. It will show that you have done some specialization for the required position.</h4>''',unsafe_allow_html=True)
                ...
                if 'PROJECTS' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #FFB6C1;'>[-] Please add Projects. It will show that you have done work related the required position or not.</h4>''',unsafe_allow_html=True)
                ...
                resume_name = resume_data['name'] if resume_data['name'] else "Unknown"
                resume_email = resume_data['email'] if resume_data['email'] else "Unknown"

                insert_data(str(sec_token), str(ip_add), (host_name), (dev_user), (os_name_ver), (latlong), (city), (state), (country), (act_name), (act_mail), (act_mob), resume_name, resume_email, str(resume_score), timestamp, str(resume_data['no_of_pages']), reco_field, cand_level, str(resume_data['skills']), str(recommended_skills), str(rec_course), pdf_name)
